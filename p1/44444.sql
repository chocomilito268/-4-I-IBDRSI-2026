...
DROP TABLE Angel.CATEGORIES;

CREATE TABLE `Angel`.`AUTHORS` (
ID INT not null auto_increment PRIMARY KEY,
 NAME VARCHAR(50) NOT NULL,
 AUTHORSid varchar(50)
 );
 
 DROP TABLE Angel.AUTHORS;

INSERT INTO
	`Angel`.`CATEGORIES`(CATEGORYID,NAME)
VALUES
	(1, 'Cat-A'),
	(2, 'Cat-B'),
	(3, 'Cat-C'),
